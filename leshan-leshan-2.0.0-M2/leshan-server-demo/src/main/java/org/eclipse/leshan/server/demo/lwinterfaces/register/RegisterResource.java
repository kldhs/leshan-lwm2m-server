 ...
 *******************************************************************************/
package org.eclipse.leshan.server.demo.lwinterfaces.register;
...
import org.eclipse.leshan.server.demo.lwinterfaces.LwM2mCoapResource;
...
public class RegisterResource extends LwM2mCoapResource {
    ...
    public void handlePOST(CoapExchange exchange) {
        ...
        LOG.error("接收---->> "+"处理客户端注册POST请求，request : {}",JSONUtil.toJsonStr(request));
    ...
    public void handleDELETE(CoapExchange exchange) {
        LOG.error("接收---->> "+"处理客户端注册DELETE请求 : {}",exchange.advanced().getRequest());
        List<String> uri = exchange.getRequestOptions().getUriPath();
    ...
    protected void handleRegister(CoapExchange exchange, Request request) {
        ...
        LOG.error("发送---->> "+"对客户端注册进行回复，response : {}", JSONUtil.toJsonStr(response));
