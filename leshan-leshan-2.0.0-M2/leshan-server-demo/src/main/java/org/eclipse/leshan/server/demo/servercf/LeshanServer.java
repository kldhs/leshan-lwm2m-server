 ...
 *******************************************************************************/
package org.eclipse.leshan.server.demo.servercf;
...
import org.eclipse.leshan.server.demo.lwinterfaces.observe.ObservationService;
import org.eclipse.leshan.server.demo.lwinterfaces.observe.ObservationServiceImpl;
import org.eclipse.leshan.server.demo.sender.*;
import org.eclipse.leshan.server.demo.servercf.registration.CaliforniumRegistrationStore;
import org.eclipse.leshan.server.demo.lwinterfaces.register.RegisterResource;
import org.eclipse.leshan.server.demo.servercore.model.LwM2mModelProvider;
import org.eclipse.leshan.server.demo.core.presence.ClientAwakeTimeProvider;
import org.eclipse.leshan.server.demo.core.presence.PresenceListener;
import org.eclipse.leshan.server.demo.core.presence.PresenceService;
import org.eclipse.leshan.server.demo.core.presence.PresenceServiceImpl;
import org.eclipse.leshan.server.demo.core.presence.PresenceStateListener;
import org.eclipse.leshan.server.demo.servercore.registration.Registration;
import org.eclipse.leshan.server.demo.lwinterfaces.register.RegistrationHandler;
import org.eclipse.leshan.server.demo.servercore.registration.RegistrationIdProvider;
import org.eclipse.leshan.server.demo.servercore.registration.RegistrationListener;
import org.eclipse.leshan.server.demo.lwinterfaces.register.RegistrationService;
import org.eclipse.leshan.server.demo.lwinterfaces.register.RegistrationServiceImpl;
import org.eclipse.leshan.server.demo.servercore.registration.RegistrationStore;
import org.eclipse.leshan.server.demo.servercore.registration.RegistrationUpdate;
import org.eclipse.leshan.server.demo.servercore.security.Authorizer;
import org.eclipse.leshan.server.demo.servercore.security.EditableSecurityStore;
import org.eclipse.leshan.server.demo.servercore.security.SecurityInfo;
import org.eclipse.leshan.server.demo.servercore.security.SecurityStore;
import org.eclipse.leshan.server.demo.servercore.security.SecurityStoreListener;
...
public class LeshanServer {
    ...
    private static final long DEFAULT_TIMEOUT = 2 * 60 * 1000l
            ; // 2min in ms
    ...
    public LeshanServer(CoapEndpoint unsecuredEndpoint, CoapEndpoint securedEndpoint,
        ...
        LOG.error("服务启动---->> "+"创建客户端注册信息访问接口服务 RegistrationServiceImpl");
    ...
    public <T extends LwM2mResponse> T send(Registration destination, DownlinkRequest<T> request)
        ...
        return send(destination, request,null, DEFAULT_TIMEOUT);
    }
